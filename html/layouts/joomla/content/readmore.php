...
<p class="readmore">
	...
	<?php elseif ($params->get('show_readmore_title', 0) == 0) : ?>
		<a class="btn" href="<?php echo $displayData['link']; ?>" itemprop="url" aria-label="<?php echo JText::_('TPL_TSB2017_COM_CONTENT_READ_MORE_TITLE'); ?> <?php echo htmlspecialchars($item->title, ENT_QUOTES, 'UTF-8'); ?>">
			<?php echo '<span class="icon-chevron-' . $direction . '" aria-hidden="true"></span>'; ?> 
			<?php echo JText::sprintf('TPL_TSB2017_COM_CONTENT_READ_MORE_TITLE'); ?><i class="ic-readmore fa fa-angle-double-right"></i>
		</a>
	<?php else : ?>
